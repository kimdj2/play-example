...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = PlayEvolutions.schema ++ Tweet.schema
  ...
  class PlayEvolutions(_tableTag: Tag) extends profile.api.Table[PlayEvolutionsRow](_tableTag, Some("twitter_clone"), "play_evolutions") {
